                    ...
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                        ...
                        <div class=" flex p-3 items-center w-full">
                            <button id="dropdownBgHoverButton" data-dropdown-toggle="dropdownBgHover"
                                ...
                                type="button">Filter by Unit/Biro <svg class="ml-2 w-4 h-4" aria-hidden="true"
                    ...
                    <tbody>
                        @foreach ($documents as $document)
                            <tr class="bg-white border-b ">
                                ...
                                <td
                                    class=" border-t-0 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-2">
                                    ...
                                    @else
                                        <div class="flex space-x-1">
                                            ...
                                            <a href="{{ route('resdel', ['restore', $document->id]) }}"
                                                alt="Restore Data"
