    ...
    <div class="relative z-10 bg-yellow-300 shadow">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                            ...
                            @auth
                                @if (Auth::user()->is_admin == 1)
                                    ...
                                    <a href="{{ route('index-unit') }}"
                                        class="{{ Request::path() == 'unit' ? 'active' : '' }} ml-4 px-3 py-2 rounded-md text-sm leading-5  text-gray-800 font-semibold hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 flex items-center">
                                        <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                            class="w-6 h-6 mr-1 {{ Request::path() == 'unit' ? 'text-indigo-400' : '' }}">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="hidden lg:block justify-end px-2 lg:ml-6 lg:justify-end">
                    @auth
                        <div class="flex items-center">
                            <span
                                class="ml-4 px-3 py-2 rounded-md text-sm leading-5  text-gray-800 font-semibold">{{ Auth::user()->name }}</span>
                            <a href="#"
                                class="flex items-center ml-4 px-3 py-2 rounded-md text-sm leading-5  text-gray-800
                        ...
                        cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700"
                                ...
                                Log Out <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
